...
declare module '@ioc:Adonis/Lucid/Model' {
     ...
     */
    type EventsList = 'save' | 'create' | 'update' | 'delete' | 'fetch' | 'find';
    ...
    interface LucidRow {
         ...
         */
        serializeRelations(fieldsToCherryPick: ModelObject | undefined, raw: true): {
            [key: string]: LucidRow | LucidRow[];
        };
        /**
         * Serialize relationships to key-value pair of plain nested objects
         */
        serializeRelations(fieldsToCherryPick: ModelObject | undefined, raw: false | undefined): ModelObject;
    ...
    interface LucidModel {
         ...
         * persisting it
         */
        firstOrNew<T extends LucidModel>(this: T, search: Partial<ModelAttributes<InstanceType<T>>>, savePayload?: Partial<ModelAttributes<InstanceType<T>>>, options?: ModelAdapterOptions): Promise<InstanceType<T>>;
        /**
         * Returns the first row or save it to the database
         */
        firstOrCreate<T extends LucidModel>(this: T, search: Partial<ModelAttributes<InstanceType<T>>>, savePayload?: Partial<ModelAttributes<InstanceType<T>>>, options?: ModelAdapterOptions): Promise<InstanceType<T>>;
        /**
         * Find rows or create in-memory instances of the missing
         * one's.
         */
        fetchOrNewUpMany<T extends LucidModel>(this: T, uniqueKey: keyof ModelAttributes<InstanceType<T>>, payload: Partial<ModelAttributes<InstanceType<T>>>[], options?: ModelAdapterOptions, mergeAttributes?: boolean): Promise<InstanceType<T>[]>;
        /**
         ...
         * Returns the first row or save it to the database
         */
        updateOrCreate<T extends LucidModel>(this: T, search: Partial<ModelAttributes<InstanceType<T>>>, updatePayload: Partial<ModelAttributes<InstanceType<T>>>, options?: ModelAdapterOptions): Promise<InstanceType<T>>;
        /**
