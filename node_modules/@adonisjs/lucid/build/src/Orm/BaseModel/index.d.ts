...
import { LucidRow, OrmConfig, CacheNode, LucidModel, EventsList, ModelObject, HooksHandler, ModelOptions, ColumnOptions, ComputedOptions, AdapterContract, ModelColumnOptions, ModelKeysContract, ModelAdapterOptions, ModelRelationOptions } from '@ioc:Adonis/Lucid/Model';
...
export declare class BaseModel implements LucidRow {
     ...
     */
    static firstOrNew(search: any, savePayload?: any, options?: ModelAdapterOptions): Promise<any>;
    /**
     * Same as `firstOrNew`, but persists the newly created model instance
     */
    static firstOrCreate<T extends LucidModel>(this: T, search: any, savePayload?: any, options?: ModelAdapterOptions): Promise<InstanceType<T>>;
    /**
     * Updates or creates a new row inside the database
     */
    static updateOrCreate(search: any, updatedPayload: any, options?: ModelAdapterOptions): Promise<any>;
    /**
     * Find existing rows or create an in-memory instances of the
     * missing one's.
     */
    static fetchOrNewUpMany(uniqueKey: any, payload: any, options?: ModelAdapterOptions, mergeAttributes?: boolean): Promise<any>;
    /**
     ...
     */
    serializeComputed(fieldsToCherryPick?: ModelObject): ModelObject;
    /**
     ...
     */
    serialize(fieldsToCherryPick?: ModelObject): {
        [x: string]: any;
    };
    /**
